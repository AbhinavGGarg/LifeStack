...
export default function AriaPage() {
  const [messages, setMessages] = useState([
    {
      role: "assistant",
      content: "Hey, I’m Aria. Tell me what you need help with and I’ll give you your next best move.",
      time: formatTime(),
    },
  ]);
        ...
        <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-[0_35px_95px_-60px_rgba(15,23,42,0.6)]">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              ...
              <h1 className="mt-1 text-3xl font-semibold tracking-tight text-slate-900">A.R.I.A.</h1>
        ...
        <section className="rounded-3xl border border-slate-200 bg-white p-5 shadow-[0_35px_95px_-60px_rgba(15,23,42,0.6)]">
          ...
          <form onSubmit={handleSubmit} className="mt-3 space-y-2">
            <textarea
              ...
              rows={3}
              placeholder="Ask Aria anything about planning, school, opportunities, or next actions..."
