...
export async function updateUserProfile(userId, profileUpdates) {
  ...
  if (hasFirebaseAdminConfig()) {
    ...
    const nextProfile = {
      ...existing.profile,
      interests: normalizedProfile.interests ?? existing.profile.interests,
      goals: normalizedProfile.goals ?? existing.profile.goals,
      gpa: normalizedProfile.gpa ?? existing.profile.gpa,
      activityHours: normalizedProfile.activityHours ?? existing.profile.activityHours,
      extracurriculars: normalizedProfile.extracurriculars ?? existing.profile.extracurriculars,
      intendedMajor: normalizedProfile.intendedMajor ?? existing.profile.intendedMajor,
      targetRole: normalizedProfile.targetRole ?? existing.profile.targetRole,
      onboardingComplete:
  ...
  users[index] = {
    ...
    profile: {
      ...users[index].profile,
      interests: normalizedProfile.interests ?? users[index].profile.interests,
      goals: normalizedProfile.goals ?? users[index].profile.goals,
      gpa: normalizedProfile.gpa ?? users[index].profile.gpa,
      activityHours: normalizedProfile.activityHours ?? users[index].profile.activityHours,
      extracurriculars: normalizedProfile.extracurriculars ?? users[index].profile.extracurriculars,
      intendedMajor: normalizedProfile.intendedMajor ?? users[index].profile.intendedMajor,
      targetRole: normalizedProfile.targetRole ?? users[index].profile.targetRole,
      onboardingComplete:
